...
| **[`GG-DEPLOY-007`](../../spec/lastenheft.md#gg-deploy-007)** | SOLLTE Kubernetes-faehig (Manifeste / Helm / Kustomize). | ✗ Post-MVP — kein `deploy/k8s/`-Artefakt im Repo (bewusste M7+-Grenze). | — | ⏸ **M7+** → [Trigger 037](../plan/planning/open/037-deploy-007-010-multi-node-deployment.md) | <!-- d-check:ignore (geplant: Trigger 037) -->
