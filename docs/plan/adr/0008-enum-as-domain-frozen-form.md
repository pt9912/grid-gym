...
**Bezug:**
[`ADR 0002`](0002-language-and-build-stack.md) §A-1 AC-DOMAIN-FROZEN
(erweiterter Vertrag),
...
`ADR 0002 §A-1` fixiert AC-DOMAIN-FROZEN als verbindliches A-1-
...
AC-DOMAIN-FROZEN akzeptiert eine dritte Frozen-Form:
...
AC-DOMAIN-FROZEN strenger als eine Aufweichung — es ist eine
...
Diese ADR aendert ausschliesslich AC-DOMAIN-FROZEN. Alle anderen
A-1-Contracts (AC-NO-JSON, AC-NO-TIME, AC-NO-RAND, AC-NO-IO-MOD,
AC-NO-GOD-UTILS, AC-TYPED-ERRORS, AC-NO-CYCLES, AC-HEXAGON-PURE,
AC-ADAPTER-LIGHTWEIGHT, AC-CORE-NO-ADAPTERS, AC-CORE-NO-DRIVING,
AC-PORTS-NO-OUT, AC-PORTS-NO-FW, AC-ADAPTER-PURE, AC-NO-FW) bleiben
unveraendert.
...
- `tools/arch_check.py` Modul-Docstring + `_check_domain_frozen`-
  ...
  Frozen-Form.
- `ADR 0002 §A-1`-Tabellenzeile AC-DOMAIN-FROZEN: Verweis auf
  diese ADR ergaenzt.
