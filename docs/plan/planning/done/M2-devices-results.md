...
- Trigger [`016-sollte-ev-charger-device`](../done-archive/016-sollte-ev-charger-device.md) — [`GG-DEV-015`](../../../../spec/lastenheft.md#gg-dev-015) EV-Charger
- Trigger [`017-sollte-transformer-device`](../done-archive/017-sollte-transformer-device.md) — [`GG-DEV-016`](../../../../spec/lastenheft.md#gg-dev-016) Transformer
- Trigger [`018-sollte-wind-device`](../done-archive/018-sollte-wind-device.md) — [`GG-DEV-017`](../../../../spec/lastenheft.md#gg-dev-017) Wind
- Trigger [`019-sollte-diesel-device`](../done-archive/019-sollte-diesel-device.md) — [`GG-DEV-018`](../../../../spec/lastenheft.md#gg-dev-018) Diesel

**SOLLTE-Netz** (M3 oder eigene Slices):

- Trigger [`020-sollte-island-grid`](../done-archive/020-sollte-island-grid.md) — [`GG-GRID-005`](../../../../spec/lastenheft.md#gg-grid-005) Inselnetz
- Trigger [`021-sollte-transformer-limits`](../done-archive/021-sollte-transformer-limits.md) — [`GG-GRID-006`](../../../../spec/lastenheft.md#gg-grid-006) Transformatorgrenzen
- Trigger [`022-sollte-reactive-power`](../done-archive/022-sollte-reactive-power.md) — [`GG-GRID-007`](../../../../spec/lastenheft.md#gg-grid-007) Blindleistung

**SOLLTE-Battery** (M3-Telemetry-Erweiterung):

- Trigger [`023-sollte-battery-temperature`](../done-archive/023-sollte-battery-temperature.md) — [`GG-BESS-006`](../../../../spec/lastenheft.md#gg-bess-006) Temperatur
- Trigger [`024-sollte-battery-cell-voltage`](../done-archive/024-sollte-battery-cell-voltage.md) — [`GG-BESS-007`](../../../../spec/lastenheft.md#gg-bess-007) Zellspannung
