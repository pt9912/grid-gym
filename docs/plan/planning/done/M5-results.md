...
| 1     | 2026-06-01   | HTTP-API-Surface (5 REST + 1 WebSocket): `POST /runs` + `GET /runs/{id}` + `/status` + `/snapshot` + `POST /control` + `POST /faults` + `WS /telemetry`. 4 neue Module mit [`AC-NO-GOD-UTILS`](../../adr/0002-language-and-build-stack.md#a-1--architekturtests-verbindlich-automatisiert)-Split (`_dependencies.py` + `_schemas.py` + `_runs_router.py` + `_runs_action_router.py`). [`ADR 0036`](../../adr/0036-ui-stack-choice.md) → `Provisional` + NEU [`ADR 0037`](../../adr/0037-http-api-surface-pattern.md) (HTTP-API-Surface-Pattern). +16 Unit + +2 Integration. | Pre-C0c `9c20dad` (HTMX-FastAPI-Smoke-Probe), C0 `e573f67`, C1 `d468e68` (NEU [`ADR 0037`](../../adr/0037-http-api-surface-pattern.md)), C2 `ae630ce`, C3 `f9f514d`, Self-Close `c7c2641`.                                                                     |
...
| ------------------------------- | -------------------------------------------------------------------------------------------------------- | ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`GG-API-001`](../../../../spec/lastenheft.md#gg-api-001) Run-Erzeugung      | `POST /runs` mit Pydantic-Schema + `RunRepository.save`.                                                 | 1                   | `tests/integration/test_m5_welle_1_htmx_probe.py` + `tests/unit/adapters/driving/http_api/test_runs_router.py`.                                                |
| [`GG-API-002`](../../../../spec/lastenheft.md#gg-api-002) WS-Telemetrie      | `WS /runs/{id}/telemetry` mit `TelemetryStreamPort.subscribe`.                                            | 3                   | `tests/integration/test_m5_welle_3_async_pubsub_probe.py`.                                                                                                     |
| [`GG-API-003`](../../../../spec/lastenheft.md#gg-api-003) OpenAPI-Vertrag    | `GET /openapi.json` mit OpenAPI 3.1.                                                                      | 1                   | `make openapi-validate`.                                                                                                                                       |
| [`GG-API-004`](../../../../spec/lastenheft.md#gg-api-004) Fehler-Envelope    | Strukturierte Fehler `{code, message, details, run_id}` ueber alle Endpoints.                            | 1+4a+4b+5+6a+6b     | 404/422-Asserts in allen Welle-Smokes.                                                                                                                         |
| [`GG-UI-001`](../../../../spec/lastenheft.md#gg-ui-001) UI-Layout           | Web-UI mit Navigation.                                                                                   | 2                   | `templates/base.html` + `navigation.html`.                                                                                                                     |
| [`GG-UI-002`](../../../../spec/lastenheft.md#gg-ui-002) Live-Telemetry      | Chart.js-Time-Series via HTMX-WS.                                                                        | 3                   | `tests/integration/test_m5_welle_2_ui_smoke.py` (UI-Foundation) + Dashboard-Page.                                                                              |
| [`GG-UI-003`](../../../../spec/lastenheft.md#gg-ui-003) Zeitreihen          | Time-Series-Rendering pro Device.                                                                        | 3                   | `_dashboard_content.html` + Chart.js-Config.                                                                                                                   |
| [`GG-UI-004`](../../../../spec/lastenheft.md#gg-ui-004) Replay-Controls     | Pause/Resume/Stop UI mit HTMX-POST.                                                                       | 4a                  | `tests/integration/test_m5_welle_4a_replay_controls_smoke.py`.                                                                                                 |
| [`GG-UI-005`](../../../../spec/lastenheft.md#gg-ui-005) Alarm-Tabelle       | 6-Spalten-UI mit Live-Updates.                                                                            | 4b                  | `tests/integration/test_m5_welle_4b_alarms_smoke.py`.                                                                                                          |
| [`GG-UI-006`](../../../../spec/lastenheft.md#gg-ui-006) Geraete-Grafik      | HTMX-Polling-Tabelle Devices/State/Quality.                                                              | 6b                  | `tests/integration/test_m5_welle_6b_visualization_smoke.py`.                                                                                                   |
| [`GG-UI-007`](../../../../spec/lastenheft.md#gg-ui-007) Fault-Form          | UI-Form mit Cross-Field-Validation.                                                                       | 6a                  | `tests/integration/test_m5_welle_6a_fault_smoke.py`.                                                                                                           |
| [`GG-UI-008`](../../../../spec/lastenheft.md#gg-ui-008) Sim-Zustand         | UI-Page `/system` mit Status + Health.                                                                    | 6b                  | `tests/integration/test_m5_welle_6b_visualization_smoke.py`.                                                                                                   |
| [`GG-UI-009`](../../../../spec/lastenheft.md#gg-ui-009) Quality-Marker      | 6-Zustands-Quality-Visualisierung.                                                                       | 3+6b                | Welle-3-Dashboard + Welle-6b-Devices-Page.                                                                                                                     |
| [`GG-DEMO-001`](../../../../spec/lastenheft.md#gg-demo-001)..005 MUSS-IDs     | Demo-Umgebung + Netz + Batterie + Live-Telemetry binnen 30 s + Replay.                                   | 5                   | `tests/integration/test_m5_welle_5_demo_smoke.py` + Welle-5-Determinismus-Hash-Pin.                                                                            |
| [`GG-DEMO-006`](../../../../spec/lastenheft.md#gg-demo-006) Demo-Faults       | YAML-side Fault-Injection (`cell_failure` + `voltage_drop`).                                              | 6a                  | `test_m5_welle_6a_fault_smoke.py::test_demo_yaml_faults_compose_and_apply_during_windows`.                                                                     |
| [`GG-DEMO-007`](../../../../spec/lastenheft.md#gg-demo-007) Demo-Agent        | RuleBasedAgent in der Demo-YAML.                                                                          | 5                   | `gg-demo.yaml` + Welle-5-Smoke.                                                                                                                                |
| [`GG-DEMO-008`](../../../../spec/lastenheft.md#gg-demo-008) Abnahmereihenfolge | Doku mit 6 Schritten (Start / Health / Scenario / Fault / Replay / Export).                              | 6c                  | [`docs/user/gg-demo-008-abnahme.md`](../../../user/gg-demo-008-abnahme.md).                                                                                    |
...
Doku-Pruefung gegen [`GG-DEMO-008`](../../../../spec/lastenheft.md#gg-demo-008)-Akzeptanztext war
ausreichend.
...
[`GG-API-004`](../../../../spec/lastenheft.md#gg-api-004)-Spalte + §6/§7-Reihenfolge gegen M4-Pattern), 4
LOW (`Welle-7-Welle-7`-Duplikat, doppeltes EoD-Sync-Hash-
Label, fehlende Welle-5-Spur in [`GG-API-004`](../../../../spec/lastenheft.md#gg-api-004)-Coverage, intern
...
- **CSV/JSONL-Export-Endpunkte:** Welle-6c-Abnahmedoku
  ...
  ist [`GG-ACCEPT-003`](../../../../spec/lastenheft.md#gg-accept-003)-Welle-7-Welle-7-Material (M6 oder
  separater Slice).
- **Inline-SVG-Geraete-Grafik:** Welle-6b liefert HTMX-
  Polling-Tabelle als [`GG-UI-006`](../../../../spec/lastenheft.md#gg-ui-006)-Erfuellung; Inline-SVG-
...
- **Snapshot-Envelope-v2-Serialisierung** (`GET /snapshot`-
  Body) — bleibt M6.
- **CSV/JSONL-Export** — [`GG-ACCEPT-003`](../../../../spec/lastenheft.md#gg-accept-003)-Material (M6 oder
  eigener Slice).
...
- **Tutorial / Onboarding-Doku** ([`GG-ACCEPT-001`](../../../../spec/lastenheft.md#gg-accept-001)) —
...
- **Multi-User + Auth im UI-Layer** — `Out-of-Scope`-
  ...
  einzelner Lastenheft-ID). [`GG-SAFE-008`](../../../../spec/lastenheft.md#gg-safe-008) selbst verlangt
...
- Lastenheft:
  ...
  §16 ([`GG-API-001`](../../../../spec/lastenheft.md#gg-api-001)..004) + §17 ([`GG-UI-001`](../../../../spec/lastenheft.md#gg-ui-001)..009) + §24
  ([`GG-DEMO-001`](../../../../spec/lastenheft.md#gg-demo-001)..008).
