...
[`M4-welle-0.md`](../done-archive/M4-welle-0.md),
[`M4-welle-1.md`](../done-archive/M4-welle-1.md),
[`M4-welle-2.md`](../done-archive/M4-welle-2.md),
[`M4-welle-3.md`](../done-archive/M4-welle-3.md),
[`M4-welle-4.md`](../done-archive/M4-welle-4.md),
[`M4-welle-5a.md`](../done-archive/M4-welle-5a.md),
[`M4-welle-5b.md`](../done-archive/M4-welle-5b.md),
[`M4-welle-6a.md`](../done-archive/M4-welle-6a.md),
[`M4-welle-6b.md`](../done-archive/M4-welle-6b.md);
...
| 1     | 2026-05-30   | [`ADR 0030`](../../adr/0030-device-protocol-port-surface.md) `DeviceProtocolPort-Surface` (Proposed → Provisional); `DeviceProtocolPort`-Protocol + `TickLoop`-Lifecycle-Methoden + 6 typed-Errors + 23 neue Unit-Tests                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `f8cbe9d` (C0), `b840e7a` (C1 ADR Proposed), `d09adf3` (C2 Implementation), `5f03bbf` (C3), `82f947c` (Linter-Folge), Self-Close `81b5cba`                                                                     |
| 2     | 2026-05-30   | [`ADR 0031`](../../adr/0031-mqtt-adapter-profile.md) `MQTT-Adapter-Profile` (Provisional); `protocol_mqtt`-Modul + QoS-0/1 + Per-Target `queue.Queue`-Marshal + Mosquitto-Integration-Smoke + 50 neue Unit-Tests                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `3b633f6` (C0), `4e102b8` (C1 ADR), `f33bb4e` (C2 Implementation), `7e161f5` (C3), `b7bf40d` (Review-Folge), `51b8694` (Linter), Self-Close `0d6ad6c`                                                          |
| 3     | 2026-05-30   | [`ADR 0032`](../../adr/0032-modbus-adapter-profile.md) `Modbus-TCP-Adapter-Profile` (Provisional); `protocol_modbus`-5-Modul-Paket + 5 Datatypes + FC03/FC10-Defaults + in-process pymodbus-Smoke + 95 neue Unit-Tests; Slice 031 (Review-Folge 8 Findings)                                                                                                                                                                                                                                                                                                                                                                                                                          | `8ef1e72` (C0), `a86ac46` (C1 ADR), `d721982` (C2 Implementation), `7e0a5e6` (C3), Slice 031 `b8cd7e1`, Self-Close `506c8ca`                                                                                   |
...
- **Pro-Welle Test-Inkrement** ggue. M3-Welle-7-Stand
  ...
  - Welle 6a (OTel-Span-Wrap + Planted-Violator):
    **+20** (13 OTel-Span-Wrap + 7
    [`AC-ADAPTER-LIGHTWEIGHT`](../../adr/0002-language-and-build-stack.md#a-1--architekturtests-verbindlich-automatisiert)-Planted-Violator-Tests).
...
| 1     | ✓ [`ADR-0030`](../../adr/0030-device-protocol-port-surface.md)-Review (initial) + Linter-Folge                                                            | in C2-Commit `d09adf3` kombiniert; `82f947c` (Linter-Folge fuer mypy-strict-bytes-Vorlauf)                                                                                             |
| 2     | ✓ Welle-2-Review-Folge + Linter-Folge                                                                 | `b7bf40d` (Review-Folge), `51b8694` (Linter-Folge)                                                                                                                                    |
| 3     | ✓ Slice 031 (Welle-3-Review-Folge 8 Findings: FC06-Multi-Register-Guard, operation-spezifische Errors) | [`done/031-modbus-adapter-review-folge.md`](../done-archive/031-modbus-adapter-review-folge.md); Self-Close `0d6ad6c`                                                                                  |
| 4     | ✓ Slice 032 (Welle-4-Review-Folge 6 HIGH + 11 MEDIUM)                                                 | [`done/032-opcua-adapter-review-folge.md`](../done-archive/032-opcua-adapter-review-folge.md); `45bcf97` (feat) + `e8fc116` (doc) + `1c2dfa3` (Nachzug)                                               |
...
| 5b    | ✓ C1-Review-Folge (4 Findings: API-Korrektur + Lizenz-Refit + IedServer-Modell-Pflicht + Sync) + Slice 033 (C2-Review-Folge 15 Findings 10 HIGH + 5 MEDIUM) | `da8aed9` (C1-Review), [`done/033-iec61850-adapter-review-folge.md`](../done-archive/033-iec61850-adapter-review-folge.md) `7e0c91b`                                                                   |
| 6a    | ✓ Slice 034 (Welle-6a-Closure-Review 15 Findings 1 HIGH + 6 MEDIUM + 4 LOW-MED + 4 LOW; F13 als Welle-6b-Vorlauf) | [`done/034-iec61850-otel-wrap-review-folge.md`](../done-archive/034-iec61850-otel-wrap-review-folge.md) `bde8fdb` + Hash-Sync `b6a778d`                                                                |
...
[`M4-protocol-adapters.md §3 Welle 7`](../done-archive/M4-protocol-adapters.md)
S-1..S-6-Items:
...
- **S-2 (Sub-Slicing-Schwelle)** — erfuellt in
  [`M4-protocol-adapters.md §3 Praeambel`](../done-archive/M4-protocol-adapters.md);
...
- **S-5 (ADR-Erweiterungs-Pattern, ohne Supersedes)** —
  ...
  ([`ADR-0011`](../../adr/0011-schaerfung-ohne-abloesung.md)-Pattern konsequent fortgefuehrt). [`ADR 0030`](../../adr/0030-device-protocol-port-surface.md)
  ist neuer Port-Slot; [`ADR 0031`](../../adr/0031-mqtt-adapter-profile.md)/0032/0033/0034/0035 sind
  Adapter-Profile, die [`ADR 0030`](../../adr/0030-device-protocol-port-surface.md) konkret fuer den
...
([`Trigger 009`](../done-archive/009-iec61850-smoke-reactivation.md)):
...
- Aktuell aktiv via Pfad C (Mock-only-Fallback). Konkrete
  ...
  - **Pfad B aktiv**: Dockerfile-Multi-Python-Test-Stage
    ...
    Schaerfungs-Welle; ggf. [`ADR 0036`](../../adr/0036-ui-stack-choice.md)). Repo-Novum-
    Material.
...
- ⏳ `done/M4-protocol-adapters.md` →
  ...
  [`ADR 0030`](../../adr/0030-device-protocol-port-surface.md)..0035 (Verfahren per
