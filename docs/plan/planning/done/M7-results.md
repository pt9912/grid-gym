...
[`GG-MVP-002`](../../../../spec/lastenheft.md#gg-mvp-002) + [`GG-MVP-003`](../../../../spec/lastenheft.md#gg-mvp-003) produktiv, [`GG-SAFE-003`](../../../../spec/lastenheft.md#gg-safe-003)/004
geschlossen → **alle vier `GG-MVP-*`-Punkte (001/002/003/004)
UND alle vier [`GG-SAFE-001`](../../../../spec/lastenheft.md#gg-safe-001)..004-MUSS-IDs produktiv**; Trigger
...
| 1a | 2026-06-08/09 | Zeitreihen-Persistenz ([`GG-PERSIST-001`](../../../../spec/lastenheft.md#gg-persist-001)): NEU `TelemetrySinkPort` (Driven) + Postgres-/InMemory-Adapter + Alembic-`0002` + Core-`telemetry_sink`-Kwarg. NEU [`ADR 0047`](../../adr/0047-telemetry-sink-timeseries-persistence.md). | `933c9d5..4b9be80` (C1 ADR `3ebb197`; C2 `4d00327`; Review-Folge `5983853`) |
...
| 1b-b | 2026-06-09 | Replay-Lifecycle-Closure: Core-`finalize()`-Naht + `replay_diff_status`-Gauge + [`GG-TERM-002`](../../../../spec/lastenheft.md#gg-term-002)/003-MVP-Preflight + Zwei-Lauf-E2E-Beleg. NEU [`ADR 0049`](../../adr/0049-replay-lifecycle-finalize-hook.md) + NEU Trigger 039 (API-Replay). **[`GG-MVP-002`](../../../../spec/lastenheft.md#gg-mvp-002) ✓ produktiv**; [`GG-SAFE-006`](../../../../spec/lastenheft.md#gg-safe-006) ⚠ → ✓; Trigger 036 aufgeloest. **Welle 1 komplett.** | `c193788..e6a2126` (C1 ADR `021e8d7`; C2 `6476267`; Review-Folge `4c6f4d6`) |
| 2 | 2026-06-09/10 | Abnahme-CLI ([`GG-MVP-003`](../../../../spec/lastenheft.md#gg-mvp-003)): NEU `make accept` + `tools/accept.py` + `AbnahmeReport`-Schema + Shared `scenario_yaml` + `check_demo_scenario_pin`-Lint. NEU [`ADR 0050`](../../adr/0050-adapter-pure-bridge-retirement.md)/0051 (`Proposed`, Review-Folge-Material) + NEU Trigger 040 (finalize-Headless-Naht). **[`GG-MVP-003`](../../../../spec/lastenheft.md#gg-mvp-003) ✓ produktiv → alle vier `GG-MVP-*` produktiv.** | `27df91b..d8ab5d6` (C2 `33ac255`; Review-Folge `92d10f5`) |
| 3a | 2026-06-11 | `max_age`-`STALE`-Stage ([`GG-SAFE-004`](../../../../spec/lastenheft.md#gg-safe-004)): NEU `TickLoop`-Kwarg `max_age_ms` + Core-Stage vor `TickResult`-Bau + `from_snapshot`-Resume-Symmetrie. NEU [`ADR 0052`](../../adr/0052-max-age-stale-quality-stage.md). **[`GG-SAFE-004`](../../../../spec/lastenheft.md#gg-safe-004) ✓**; Trigger 034 aufgeloest. | `9e266d2..4b3d2f1` (C1 ADR `744e31e`; C2 `23c614a`; Review-Folge `5a9960a`) |
| 3b | 2026-06-11/12 | Comm-Failure-Wrapper ([`GG-SAFE-003`](../../../../spec/lastenheft.md#gg-safe-003)): NEU `CommFailureGuardedDeviceProtocolPort` (read-Fehler → `MISSING`-Point + `adapter_communication_lost`-Alarm) + NEU `_protocol_wrap_common.py`. NEU [`ADR 0053`](../../adr/0053-comm-failure-wrapper-missing-quality-alarm.md). **[`GG-SAFE-003`](../../../../spec/lastenheft.md#gg-safe-003) ✓ — alle vier [`GG-SAFE-001`](../../../../spec/lastenheft.md#gg-safe-001)..004 produktiv**; Trigger 035 aufgeloest. **Welle 3 komplett.** | `6324042..427f3c2` (C1 ADR `caae16e`; C2 `3f28be1`; Review-Folge `82704b1`) |
...
| -------------------- | ------------- |
| [`GG-MVP-001`](../../../../spec/lastenheft.md#gg-mvp-001)..004 | ✓ produktiv komplett: 001/004 (M1..M6-Bestand) + **002** (Welle 1: ReplaySource-Integration, Zwei-Lauf-E2E-Beleg `docs/user/replay-determinism-e2e.md`) + **003** (Welle 2: `make accept`-Aggregat-Abnahme als `AbnahmeReport`-JSON). |
| [`GG-PERSIST-001`](../../../../spec/lastenheft.md#gg-persist-001) | ✓ produktiv (Welle 1a): Zeitreihen-Persistenz mit allen Pflichtfeldern + deterministischer Sortier-Invariante ([`ADR 0047`](../../adr/0047-telemetry-sink-timeseries-persistence.md)). |
...
| [`GG-TERM-002`](../../../../spec/lastenheft.md#gg-term-002)/003 | MVP-Preflight produktiv (Welle 1b-b; 5 `RunMetadata`-Felder); volle Equality-Matrix → [Trigger 038](../open/038-gg-term-002-003-full-equality-matrix.md). |
...
- **S-6 Lastenheft-Coverage-Sweep:** MVP-Scope komplett
  ([`GG-MVP-001`](../../../../spec/lastenheft.md#gg-mvp-001)..004 ✓); [`GG-SAFE-001`](../../../../spec/lastenheft.md#gg-safe-001)..008 produktiv oder
  bewusst verankert (005 ✓, 006 ✓, 007/008 ✓ seit M6);
  verbleibende Kategorien ([`GG-DEPLOY-007`](../../../../spec/lastenheft.md#gg-deploy-007)..010, GG-TERM-
...
- **Offene `open/`-Trigger:** 033 (OTel-Collector
  ...
  ([`GG-DEPLOY-007`](../../../../spec/lastenheft.md#gg-deploy-007)..010 Multi-Node/K8s), 038 (volle
  [`GG-TERM-002`](../../../../spec/lastenheft.md#gg-term-002)/003-Equality-Matrix), 039 (oeffentliche
...
- **Volle [`GG-TERM-002`](../../../../spec/lastenheft.md#gg-term-002)/003-Equality-Matrix** — MVP-Preflight
