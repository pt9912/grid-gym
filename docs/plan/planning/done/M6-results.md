...
[`M6-welle-0.md`](../done-archive/M6-welle-0.md),
[`M6-welle-1.md`](../done-archive/M6-welle-1.md),
[`M6-welle-2.md`](../done-archive/M6-welle-2.md),
[`M6-welle-3.md`](../done-archive/M6-welle-3.md),
[`M6-welle-4a.md`](../done-archive/M6-welle-4a.md),
[`M6-welle-4b-a.md`](../done-archive/M6-welle-4b-a.md),
[`M6-welle-4b-b.md`](../done-archive/M6-welle-4b-b.md),
[`M6-welle-4b-c.md`](../done-archive/M6-welle-4b-c.md),
[`M6-welle-5a.md`](../done-archive/M6-welle-5a.md),
[`M6-welle-5b.md`](../done-archive/M6-welle-5b.md),
[`M6-welle-5c.md`](../done-archive/M6-welle-5c.md),
[`M6-welle-6.md`](../done-archive/M6-welle-6.md),
...
- **Welle 1** — Trigger-010-Closure ohne Code-Edit (Upstream-Drift-
  Verifikation); [`ADR 0043`](../../adr/0043-image-audit-strategy.md) §2.2-Defer-Form als Quality-Gate-Vertrag.
- **Welle 4a** — vulnignore-Pattern-Import aus m-trace; [`ADR 0044`](../../adr/0044-generated-trivyignore-permit.md) als
  additive §2.2-Erweiterung (kein Supersedes).
- **Welle 4b-a/b/c** — je Self-Review-Folgen (4b-a 4 Findings inkl.
  [`ADR-0041`](../../adr/0041-performance-bench-pattern.md)-§2.2-Vertragsbruch rueckwirkend; 4b-b 7 Findings; 4b-c
  2× 7 Findings).
...
- **S-4 Image-Audit:** `make image-audit` cache-frei gruen
  ...
  Trigger 033 als [`ADR-0044`](../../adr/0044-generated-trivyignore-permit.md)-vulnignore-Temp-Deferral).
- **S-5 ADR-Erweiterungs-Pattern:** M6 = **6 ADRs** (0041..0046),
  innerhalb der empirischen M3/M4/M5-Spannweite (5-6 ADRs/
  Meilenstein); kein ADR-Sollwert ([`ADR 0011`](../../adr/0011-schaerfung-ohne-abloesung.md) = Schaerfung-ohne-
...
- **IEC-61850 Pfad-A-Watch:** sobald `pyiec61850-ng` ein
  ...
  `chore(deps)`-Slice; [`ADR 0046`](../../adr/0046-multi-python-test-stage-pattern.md) §7).
...
| 0044 | Generated-Trivyignore-Permit ([`ADR-0011`](../../adr/0011-schaerfung-ohne-abloesung.md)-Schaerfung an 0043) | 4a | Accepted (W7-C1) |
| 0045 | HTTP-API-Request-Body-Strict-Validation ([`ADR-0011`](../../adr/0011-schaerfung-ohne-abloesung.md)-Schaerfung an 0037) | 5b | Accepted (W7-C1) |
| 0046 | Multi-Python-Test-Stage-Pattern ([`ADR-0011`](../../adr/0011-schaerfung-ohne-abloesung.md)-Schaerfung an 0002) | 6 | Accepted (W7-C1) |

Drei der sechs M6-ADRs sind [`ADR-0011`](../../adr/0011-schaerfung-ohne-abloesung.md)-Schaerfungen bestehender
...
- **OTel-Collector-CVE-2026-42504** — Temp-Deferral via vulnignore
  ([`ADR 0044`](../../adr/0044-generated-trivyignore-permit.md)); echte Aufloesung bei Stable-Release-Bump (Trigger
  033).
- **Container-Image-Signing / Multi-Arch / PyPI-Publishing** —
  M7+ ([`ADR 0042`](../../adr/0042-sbom-tool-and-release-pattern.md) Out-of-Scope).
