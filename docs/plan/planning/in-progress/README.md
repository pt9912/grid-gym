...
| `M3-welle-6.md`           | Welle-6-Slice-Begleit: telemetry-otlp-Adapter (gRPC) + Compose-Collector-Sibling + Integration-Smoke (≥1 Span + ≥1 Metric). Stand 2026-05-24: `In Progress` — C0 eroeffnet; C1 ist `feat`+ADR-0024-Schaerfung, C2 `deploy/compose.yml`, C3 Smoke+Runbook. |
