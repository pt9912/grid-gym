...
| `welle-2.md`              | M3-Welle-2-Slice-Begleit-Dokument (Battery-/Grid-Fault-Konkretisierung: ADR 0025 Recovery-Pattern + `BatteryFaultAdapter` + `GridFaultAdapter` + `cell_failure` + `voltage_drop` + Recovery-Logik + Fault-Demo-Szenario). Stand 2026-05-20: `In Progress`. Zweite Code-Welle in M3. |
