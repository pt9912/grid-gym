...
| [`M6-welle-2.md`](M6-welle-2.md) | M6-Welle-2-Slice-Doc (SBOM-Aktivierung + Release-Workflow; Trigger 008 + `GG-CICD-007` Vollscope mit 5 Asset-Klassen + 1 GHCR-Push). — **Done 2026-06-05** mit Stack `0cc28f3..<C3-Hash>` (C0 + 2 Review-Folgen + C1 ADR 0042 `Provisional` + C2 `235395e` Code-Merge + C3 dieser Commit; Self-Close-Move-Folge C4a/C4b ausstehend als Welle-3-Pre-C0a/Pre-C0b). |
