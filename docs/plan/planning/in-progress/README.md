...
| [`M6-welle-2.md`](M6-welle-2.md) | M6-Welle-2-Slice-Doc (SBOM-Aktivierung + Release-Workflow; Trigger 008 + `GG-CICD-007` Vollscope mit 5 Asset-Klassen). — **In Progress 2026-06-05** mit C0 (dieser Commit) als Slice-Doc-Anlage; C1 plant NEU ADR 0042 (SBOM-Tool + Release-Pattern); C2 plant NEU `.github/workflows/release.yml` + ggf. `Makefile`-Schaerfung; C3 plant Status-Sync + Trigger-008-`done/`-Move + Top-Level-Doku-Sync. |
