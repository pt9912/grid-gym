...
| [`M6-welle-4b-b.md`](M6-welle-4b-b.md) | M6-Welle-4b-b-Slice-Doc (`GG-RT-005` Telemetry-Port-Throughput-Bench; 10 000 Points/s am `TelemetryStreamPort.publish`-Inlet mit Payloads ≤ 256 Byte). — **In Progress 2026-06-06** mit C0 (dieser Commit; Slice-Doc-Anlage). Nutzt Welle-4b-a-Bench-Foundation 1:1; C1 entfaellt (Welle-4b-b-D-4). |
