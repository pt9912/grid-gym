...
| [`M6-welle-4b-c.md`](M6-welle-4b-c.md) | M6-Welle-4b-c-Slice-Doc (`GG-RT-001` Backpressure-Healthcheck; NEU Driving-Adapter-Side-Healthcheck-Surface mit `GET /runs/{id}/healthcheck`-Endpoint fuer Tick-Dauer/p95-Jitter/missed-Ticks/Backpressure-Status im 10ms-Modus). — **In Progress 2026-06-06** mit C0 (dieser Commit; Slice-Doc-Anlage). Welle-4b-c-D-1 entscheidet Adapter-Side-Mess (Core unangetastet, AC-NO-TIME-konform). C1 entfaellt (Welle-4b-c-D-6). |
...
Backpressure-Healthcheck; NEU Driving-Adapter-Side-Healthcheck-
Surface mit `GET /runs/{id}/healthcheck`-Endpoint fuer 10ms-
Modus). Welle 4b ist in 4b-a/4b-b/4b-c sub-geslict per Welle-
4b-a-D-1; Pattern analog M5-Welle-6.
...
`beb5dee..c8625f7` (NEU `tests/perf/test_telemetry_port_bench.py`
