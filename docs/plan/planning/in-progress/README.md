...
mit Welle 0 am 2026-05-26 eroeffnet und inhaltlich
geschlossen — Welle-0-Doc ist nach
[`../done/M4-welle-0.md`](../done/M4-welle-0.md) gewandert
(Self-Close-Move `556ae9f`). Der kanonische M4-Slice-Plan
[`M4-protocol-adapters.md`](M4-protocol-adapters.md) bleibt
in `in-progress/` bis M4-Welle-7-Closure. **Naechster aktiver
Schritt:** M4-Welle-1 (`DeviceProtocolPort`-Foundation).
