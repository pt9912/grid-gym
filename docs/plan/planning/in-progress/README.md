...
| [`M6-welle-1.md`](../done/M6-welle-1.md) | M6-Welle-1-Slice-Doc (Base-Image-Bump / krb5-CVE-Aufloesung; Trigger 010 M4-Erbschaft). — **Done 2026-06-05** mit C0 `4b1b3e9` + Review-Folgen `a28dba6` (4 Findings) + `cff5944` (1 MEDIUM) + C1 `c44e6d5` (NEU ADR 0043 `Provisional` + ADR-Index-Sync) + C2 `b514170` (Verifikations-Commit: Trigger-010-Aufloesung ohne Code-Edit + Welle-1-D-1-Vertagung auf Welle 3 ueber NEU Trigger 031) + C3 `4517614` (Status-Sync + ADR-0043-§5-Hash-Anchor + Trigger-010-Move + Top-Level-Doku-Sync). Ausstehend: C4a Self-Close-Move + C4b Cross-Doc-Refs-Sync. |
...
CI/CD-Haertung); **aktive Welle:** M6-Welle-2 (SBOM-
Aktivierung + Release-Workflow; Trigger 008 + `GG-CICD-
007`) — Welle-2-Slice-Doc entsteht in Welle-2-C0.
M6-Welle-0 abgeschlossen 2026-06-04 + M6-Welle-1 abgeschlossen
2026-06-05 (siehe Detail-Bloecke unten);
