...
| 3 | Safety-Closure (`GG-SAFE-003/004`) | **Pending — aktiver Slice** | TBD | Trigger 034 (`max_age`) + 035 (Comm-Failure) |
...
Trigger 034/035; Slice-Doc TBD via Welle-3-C0). M7-Welle-2 **Done
