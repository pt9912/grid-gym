...
| 5 | Demo-Pipeline + Scenario-Loader-Wiring | In Progress 2026-06-02 | [`M5-welle-5.md`](M5-welle-5.md) | `GG-DEMO-001..005 + 007` (Anti: 006 + 008 → Welle 6) | — (C1 entfaellt) |
...
**Welle 6 — SOLLTE-Features (Plan-Items, TBD im Welle-
6-C0-Slice-Doc):**
...
**Welle-6-Sub-Slicing-Risiko:** falls die SOLLTE-
Features einzeln zu gross werden, kann Welle 6 →
6a/6b sub-geslict werden (Pattern analog M4-Welle-6
→ 6a/6b).
