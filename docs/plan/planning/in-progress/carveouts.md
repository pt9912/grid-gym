...
| T-046 | Command-getriebener Integration-E2E fuer die SOLLTE-Geraete — **aktiviert 2026-06-18** als Scenario-Scheduled-Commands-Welle ([`ADR 0070`](../../adr/0070-scenario-scheduled-device-commands.md) `Provisional`, [`Slice-Plan`](scenario-scheduled-device-commands.md); S0 vollzogen, voller Mechanismus + 4 SOLLTE-E2E) | SOLLTE-Geraete/Netz | `In-Arbeit` | M8-Welle-2a..2d-Anti-Scope ([`M8-welle-2a.md`](../done/M8-welle-2a.md) §5) | aktiv (in-progress) | [`046`](../open/046-command-driven-integration-e2e.md) |
