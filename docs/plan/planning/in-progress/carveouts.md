...
| T-044 | d-check-`ids`-Linkpflicht auch fuer Inline-Code-Kennungen (Tool v0.11.0 `link-policy: always` geliefert + gepinnt; grid-gym-Aktivierung + ~421er-Sweep offen) | Tooling/Build | `Trigger-Gated` | Trigger-043-Folge (User-Review der Zwei-Stufen-Konvention) | aktiv (in-progress) | [`044`](044-dcheck-ids-inline-code.md) |
