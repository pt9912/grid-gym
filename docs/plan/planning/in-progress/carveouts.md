...
| T-016 EV-Charger-Device (`GG-DEV-015`) | M8-Welle-2a (NEU `hexagon/core/devices/ev_charger/` als `DeviceModel`+`FaultInjectableDevice`, [`ADR 0055`](../../adr/0055-ev-charger-device-pattern.md) `Accepted`; [`M8-welle-2a.md`](M8-welle-2a.md)) | `make gates` gruen; Trigger-Doc [`016`](../open/016-sollte-ev-charger-device.md) (Archivierung nach `done-archive/` mit M8-Closure) |
| T-017 Transformer-Device (`GG-DEV-016`) | M8-Welle-2b (NEU `hexagon/core/devices/transformer/` als `DeviceModel`+`FaultInjectableDevice`, [`ADR 0056`](../../adr/0056-transformer-device-pattern.md) `Accepted`; [`M8-welle-2b.md`](M8-welle-2b.md)) | `make gates` gruen; Trigger-Doc [`017`](../open/017-sollte-transformer-device.md) (Archivierung nach `done-archive/` mit M8-Closure) |
