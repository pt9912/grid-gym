...
| T-051 | Durchsetzungsschicht: Tool-Call-Gate + Handoff-Gate + Workflow-Skelett (v1.2.0) | Harness/Regelwerk | `Resolved` | v1.2.0-Regelwerk-Delta | **Resolved** (2026-06-19, Durchsetzungsschicht geliefert; [`ADR 0071`](../../adr/0071-enforcement-layer-hooks.md) `Accepted`) | [`051`](051-durchsetzungsschicht-enforcement-layer.md) |
