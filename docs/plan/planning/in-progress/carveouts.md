...
| T-051 | Durchsetzungsschicht: Tool-Call-Gate + Handoff-Gate + Workflow-Skelett (v1.2.0) | Harness/Regelwerk | `Trigger-Gated` | v1.2.0-Regelwerk-Delta | **erfuellt → in Arbeit** (2026-06-19, bewusste Harness-Haertung; [`ADR 0071`](../../adr/0071-enforcement-layer-hooks.md) `Provisional`) | [`051`](051-durchsetzungsschicht-enforcement-layer.md) |
