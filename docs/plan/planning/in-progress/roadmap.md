...
[Trigger 040](../done/040-replay-finalize-headless-run-end-seam.md);
...
- **Welle 2 — Geraete** ([`M8-welle-2.md`](../done/M8-welle-2.md))**.** `T-016` EV-Charger ([`GG-DEV-015`](../../../../spec/lastenheft.md#gg-dev-015),
  [`016`](../done-archive/016-sollte-ev-charger-device.md)) **Done** (2a,
  [`M8-welle-2a.md`](../done/M8-welle-2a.md), [`ADR 0055`](../../adr/0055-ev-charger-device-pattern.md) `Accepted`, Trigger 016 aufgeloest),
  `T-017`
  Transformer ([`GG-DEV-016`](../../../../spec/lastenheft.md#gg-dev-016), [`017`](../done-archive/017-sollte-transformer-device.md)) **Done** (2b,
  [`M8-welle-2b.md`](../done/M8-welle-2b.md), [`ADR 0056`](../../adr/0056-transformer-device-pattern.md) `Accepted`, Trigger 017 aufgeloest),
  `T-018` Wind ([`GG-DEV-017`](../../../../spec/lastenheft.md#gg-dev-017), [`018`](../done-archive/018-sollte-wind-device.md)) **Done** (2c,
  [`M8-welle-2c.md`](../done/M8-welle-2c.md), [`ADR 0057`](../../adr/0057-wind-turbine-device-pattern.md) `Accepted`, Trigger 018 aufgeloest),
  `T-019` Diesel ([`GG-DEV-018`](../../../../spec/lastenheft.md#gg-dev-018), [`019`](../done-archive/019-sollte-diesel-device.md)) **Done** (2d,
  ...
  **Welle 2-D8** (Cross-Cutting-Review-Folge, [`M8-welle-2-d8.md`](../done/M8-welle-2-d8.md),
...
- **Welle 3 — Netzbilanz** ([`M8-welle-3.md`](../done/M8-welle-3.md); **Done
  ...
  [`020`](../done-archive/020-sollte-island-grid.md), 3a), `T-021`
...
- **Welle 4 — BESS-Telemetrie** ([`M8-welle-4.md`](../done/M8-welle-4.md); In Arbeit,
  ...
  [`023`](../done-archive/023-sollte-battery-temperature.md), 4a),
  `T-024` Battery-Zellspannung ([`GG-BESS-007`](../../../../spec/lastenheft.md#gg-bess-007),
  [`024`](../done-archive/024-sollte-battery-cell-voltage.md), 4b). Beide opt-in +
...
aufgeloest, `D-7` adoptiert. **2b (Transformer) Done**
([`M8-welle-2b.md`](../done/M8-welle-2b.md)) —
[`ADR 0056`](../../adr/0056-transformer-device-pattern.md) **`Accepted`**
(Transformer: Wandlungsverhaeltnis + Eisen-/Kupferverluste +
Saettigungs-Hard-Cap + `winding_fault`-Schutz). NEU
`hexagon/core/devices/transformer/` ueber dieselben 8 Integrations-Naehte
(Loader-Factory + `DEVICE_DECIMAL_PARAMS` + `_DEVICE_TYPE_BY_CLASS_NAME`
...
**Slice 045** ([`045-fault-state-flag-codec-dedup.md`](../done/045-fault-state-flag-codec-dedup.md)):
...
**2c (Wind-Turbine) Done** ([`M8-welle-2c.md`](../done/M8-welle-2c.md)) —
[`ADR 0057`](../../adr/0057-wind-turbine-device-pattern.md) **`Accepted`**
(command-loser Generator, kubische cut-in/rated/cut-out-Kennlinie,
**stochastischer seeded `RandomPort`-Windeingang** — erster echter
...
([`M8-welle-2d.md`](../done/M8-welle-2d.md)) —
...
Snapshot v2→v3). **Welle 3 (Netzbilanz) Done 2026-06-16** (3a/3b/3c;
[`GG-GRID-005`](../../../../spec/lastenheft.md#gg-grid-005)..007 komplett,
[`ADR 0060`](../../adr/0060-island-grid-bilanz-pattern.md)..[`ADR 0064`](../../adr/0064-grid-connection-q-transformer-apparent-power.md)).
**Welle 4 (BESS-Telemetrie) Done 2026-06-17** (4a Temperatur
[`ADR 0065`](../../adr/0065-battery-thermal-telemetry-pattern.md) + 4b
Zellspannung [`ADR 0066`](../../adr/0066-battery-cell-voltage-telemetry-pattern.md);
[`GG-BESS-006`](../../../../spec/lastenheft.md#gg-bess-006)/007). **Welle 5
(Closure) Done 2026-07-01** ([`M8-welle-5.md`](../done/M8-welle-5.md)):
Trigger-Archival `open/016..024` → `done-archive/`, NEU
[`M8-results.md`](../done/M8-results.md), M8-Header → `Done`, Release
**v0.2.0** — alle M8-ADRs (0050/0051/0054/0055..0071) bereits
`Accepted`, daher kein Closure-ADR-Flip (Welle-5-D-2). **M8
abgeschlossen — SOLLTE-Geraete & Netz geliefert; Post-M8-Trigger-Watch**
(offen: 037 Multi-Node, 038 volle GG-TERM-Matrix, 047 SNMP/LwM2M +
Tooling-/Spike-Bestand [`carveouts.md`](carveouts.md)).
