...
**Aktive Welle: M6-Welle-4b-b** (`GG-RT-005` Telemetry-Port-
Bench; 10 000 Points/s am Telemetry-Port mit Payloads ≤ 256
Byte) **In Progress 2026-06-06** mit C0 (Slice-Doc-Anlage
[`M6-welle-4b-b.md`](M6-welle-4b-b.md)). Welle 4b ist gemaess
Welle-4b-a-D-1 in **4b-a + 4b-b + 4b-c** sub-geslict;
**M6-Welle-4b-a abgeschlossen 2026-06-06** mit Stack
`f2fbcc0..76a2f40` (NEU ADR-0041 + pytest-benchmark als
...
| 4b-b | `GG-RT-005` Telemetry-Port-Bench | In Progress 2026-06-06 | [`M6-welle-4b-b.md`](M6-welle-4b-b.md) | `GG-RT-005` SOLLTE (10 000 Points/s am Telemetry-Port mit Payloads ≤ 256 Byte) | — (C1 entfaellt; Welle-4b-b-D-4 schliesst ADR-0041-Schaerfung negativ aus) |
...
**Aktiver Slice:** M6-Welle-4b-b (`GG-RT-005` Telemetry-Port-
Bench; 10 000 Points/s am Telemetry-Port mit Payloads ≤ 256
