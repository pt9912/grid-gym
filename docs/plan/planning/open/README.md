...
| ----- | ------ | ----------- |
| [`084-architecture-bezug-drift-fix.md`](084-architecture-bezug-drift-fix.md) | Bezug-Drift-Fix (ARCH-007/008-Vollstaendigkeit + SCN-006-Luecke), [`ADR 0080`](../../adr/0080-three-layer-spec-model.md) §4.4 (ii) | nach [`083`](../done/083-spezifikation-layer-discipline-core-move.md) |
