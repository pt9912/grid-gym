...
| Datei | Trigger | Aktivierung |
| ----- | ------- | ----------- |
| [`035-safe-003-comm-failure-missing-quality.md`](035-safe-003-comm-failure-missing-quality.md) | `GG-SAFE-003` Adapter-Kommunikationsausfall → `MISSING`/`STALE` + Alarm-Emission (partial Lücke) | **Active in M7-Welle-3b** ([`../in-progress/M7-welle-3b.md`](../in-progress/M7-welle-3b.md), 3b-C0 2026-06-11): `CommFailureGuardedDeviceProtocolPort`-Wrapper + `adapter_communication_lost`-Alarm + Smoke-Reaktivierung (3b-D-1: voller Umfang, kein Carveout) |
