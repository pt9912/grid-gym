...
[`M2-devices-results.md`](../done/M2-devices-results.md) §1):
...
- M1-Closure-Notiz
  [`done/M1-tick-loop-spine.md`](M1-tick-loop-spine.md)
  + Ergebnisse
...
- Triggers
  [`done/013-replay-diff-tick-ms-parameter.md`](013-replay-diff-tick-ms-parameter.md)
...
2. **`make fullbuild` gruen** auf `main` ohne Welle-6d-Hack-
   ...
   - Base-Image-Patch-Strategie ist explizit dokumentiert:
     ...
     Notiz [`done/015-runtime-image-hardening.md`](015-runtime-image-hardening.md).
...
- **S-1 / Trigger 014** (`generic-snapshot-format-codec`)
  ...
  - Closure-Notiz: [`done/014-generic-snapshot-format-codec.md`](014-generic-snapshot-format-codec.md).
...
- **S-4 / Trigger 015** (`runtime-image-hardening`)
  ...
  - `make fullbuild` cache-frei gruen ohne Pragma-Hacks; 268
    Unit-Tests gruen.
  - Closure-Notiz: [`done/015-runtime-image-hardening.md`](015-runtime-image-hardening.md).
