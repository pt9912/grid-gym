...
[`../done/M6-welle-0.md`](M6-welle-0.md)).
...
Scenario-Demo-Lifespan) / C3 `79563c0` (Status/DoD-Sync) /
C4a `79ac725` (Self-Close-Move rename-only) + C4b `d8dd8d2`
(Cross-Doc-Refs-Sync). `GG-DEPLOY-001..006/011` ✓ produktiv,
`GG-DEPLOY-007..010` ⏸ M7+; Trigger 009 aufgeloest
(`open → done`); NEU ADR 0046 bleibt `Provisional` bis
M6-Welle-7-Closure. Self-Close-Folge C4a/C4b dient als
M6-Welle-7-Pre-C0a/Pre-C0b. **M6-Welle-5c abgeschlossen 2026-06-07**
mit Stack
...
parallel + C2 `b580840` 6 Inline-Fixes + `_BaseRequest`-Mixin
+ 11 Smokes + Audit-Doku + C3 dieser Commit ADR-Flip auf
`Provisional` + Status-Sync); alle 6 GG-SAFE-007-Surfaces
+ 6 GG-SAFE-008-Surfaces ✓ produktiv (siehe
[`../../../user/safe-007-008-sim-prod-input-validation.md`](../../../user/safe-007-008-sim-prod-input-validation.md)). **M6-Welle-5a
...
| - | ----- | ------ | --------- | ----------------------------- | ---- |
| 0 | Slice-Plan-Eroeffnung + Trigger-Triage | Done 2026-06-04 | [`M6-welle-0.md`](M6-welle-0.md) | Plan-Welle (7 Decisions vorbelegt) | — (kein C1) |
...
| 4b-b | `GG-RT-005` Telemetry-Port-Bench | Done 2026-06-06 | [`M6-welle-4b-b.md`](M6-welle-4b-b.md) | `GG-RT-005` SOLLTE **produktiv** (10 000 Points/s am Telemetry-Port mit Payloads ≤ 256 Byte; lokal ~788k Publish-OPS) | — (C1 entfaellt; Welle-4b-b-D-4 schliesst ADR-0041-Schaerfung negativ aus) |
| 4b-c | `GG-RT-001` Backpressure-Healthcheck | Done 2026-06-06 | [`M6-welle-4b-c.md`](M6-welle-4b-c.md) | `GG-RT-001` MUSS **produktiv** (Tick-Dauer/p95-Jitter/missed-Ticks/Backpressure-Status-Healthcheck via NEU Adapter-Side `_tick_loop_healthcheck.py` + `GET /runs/{id}/healthcheck`-Endpoint) | — (C1 entfaellt; Welle-4b-c-D-6 schliesst ADR-Schaerfungs-Bedarf negativ aus) |
...
abgeschlossen 2026-06-08** mit Stack `fab6a8c..d8dd8d2`
(C0..C4b); `GG-DEPLOY-001..006/011` ✓ produktiv, `007..010`
...
[`M6-welle-1.md`](M6-welle-1.md); Stack umfasst
...
(siehe [`../done/M6-welle-0.md`](M6-welle-0.md)).
...
NEU `.devcontainer/`-Konfig; Trigger 009 NEU Dockerfile-
Stage `iec61850-test` auf Python 3.12 + Makefile-Target
`test-iec61850`. NEU ADR 0046 `Multi-Python-Test-Stage-
Pattern` (Welle-6-C1) als ADR-0011-Schaerfung.
...
- `roadmap.md §4 M6` DoD-Checkboxen alle `[x]`; M6 auf
