...
[`../done/M5-welle-0.md`](M5-welle-0.md).
...
| ---- | ------ | ----------- |
| `GG-MVP-002` ReplaySource-Integration | [`M7-welle-1.md`](M7-welle-1.md) | **Pflicht-Substanz** — `ReplaySourcePort`-Adapter + `replay_diff_status`-Metrik + Core-Spine-Lifecycle-Hook; aktiviert [Trigger 036](036-safe-006-replay-diff-status-replay-source-integration.md). ~6-7 Tage. |
...
- [`../done/M6-welle-0.md`](M6-welle-0.md) +
  [`../done/M5-welle-0.md`](M5-welle-0.md) — Welle-0-
  Vorbild-Slice-Docs.
