...
[`Trigger 008`](008-sbom-activation.md) (gewandert
nach `done/` mit M6-Welle-2-C3 — Pattern analog Trigger 010),
keine eigene
`GG-SBOM-*`-Familie). Pattern analog M5-Welle-0
([`../done/M5-welle-0.md`](M5-welle-0.md)) und
M4-Welle-0 ([`../done/M4-welle-0.md`](M4-welle-0.md)).
...
- **`make fullbuild`** pre-existing rot seit M3-Welle-7-
  ...
  in [`../open/`](010-base-image-krb5-cve-bump.md)
...
- [`../done/M5-welle-0.md`](M5-welle-0.md) +
  [`../done/M4-welle-0.md`](M4-welle-0.md) —
