...
siehe [`../done/029-otlp-span-grpc-export-edge-case.md`](029-otlp-span-grpc-export-edge-case.md)
...
- [x] **`make test-integration` gruen** — Welle-6-Smoke fuegt
      ...
      Trigger-029-Closure
      [`../done/029-otlp-span-grpc-export-edge-case.md`](029-otlp-span-grpc-export-edge-case.md)).
...
- C3 traegt zusaetzlich Status `In Progress → Done`,
  ...
  [`in-progress/README.md`](../done/README.md) + Slice-Plan-Status-
  Text-Sync.
...
- M3-Slice-Plan
  ...
  (kanonische Spec).
- Welle-5-Closure-Doc
  [`done/M3-welle-5.md`](M3-welle-5.md) — §4.4 Welle-6-
...
- Trigger 006
  [`open/006-mypy-strict-bytes.md`](006-mypy-strict-bytes.md)
