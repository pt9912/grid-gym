...
| - | ----- | ------ | --------- | ------------------- | ---- |
| 0 | Slice-Plan-Eroeffnung + Trigger-Triage | Done 2026-06-01 | [`M5-welle-0.md`](M5-welle-0.md) | Plan-Welle (10 Decisions vorbelegt) | ADR 0036 `Proposed` |
| 1 | HTTP-API-Surface | Done 2026-06-01 | [`M5-welle-1.md`](M5-welle-1.md) | `GG-API-001..004` | ADRs 0036 + 0037 `Provisional` |
| 2 | UI-Foundation | Done 2026-06-01 | [`M5-welle-2.md`](M5-welle-2.md) | UI-Foundation (Layout + Templates + HTMX/Chart.js) | — (C1 entfaellt) |
| 3 | Live-Telemetry-Dashboard | Done 2026-06-01 | [`M5-welle-3.md`](M5-welle-3.md) | `GG-UI-001/002/003/009 + GG-API-002` | ADR 0038 `Provisional` |
| 4a | Replay-Controls + TickLoop-Wiring | Done 2026-06-02 | [`M5-welle-4a.md`](M5-welle-4a.md) | `GG-UI-004` + Rest-`GG-API-001` | ADR 0039 `Provisional` |
| 4b | Alarme | Done 2026-06-02 | [`M5-welle-4b.md`](M5-welle-4b.md) | `GG-UI-005`; loest ADR-0014-§6 Driving-Side | ADR 0040 `Provisional` |
...
(siehe [`M5-welle-6a.md`](M5-welle-6a.md) §0 Sub-Slicing-
