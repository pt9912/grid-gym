...
([`../done/010-base-image-krb5-cve-bump.md`](010-base-image-krb5-cve-bump.md)
...
[`../done/M6-welle-0.md`](M6-welle-0.md) hat den
M6-Slice-Plan
...
Per [`../done/010-base-image-krb5-cve-bump.md`](010-base-image-krb5-cve-bump.md):
...
- [`../done/M6-welle-0.md`](M6-welle-0.md) — M6-
...
- Pattern-Vorbild Welle-1-Substanz-Welle nach Welle-0-
  ...
  ([`../done/M5-welle-1.md`](M5-welle-1.md)) +
  M4-Welle-1 ([`../done/M4-welle-1.md`](M4-welle-1.md)).
