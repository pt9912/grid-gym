...
- **C2-Review-Folge (Slice 033, dieser Commit)** — `feat+docs(slice-033): IEC-61850-Adapter-Review-Folge — 15 Findings (10 HIGH + 5 MEDIUM) adressiert ohne ADR-Status-Aenderung` (siehe [`../done/033-iec61850-adapter-review-folge.md`](033-iec61850-adapter-review-folge.md)).
...
- [`../done/M4-welle-0.md`](M4-welle-0.md) §3
  Decision-Liste.
- [`../done/M4-protocol-adapters.md`](M4-protocol-adapters.md) §3
  Welle 5b (kanonische Slice-Spezifikation).
- [`../done/M4-welle-5a.md`](M4-welle-5a.md) als
