...
Doku-/Tooling-Härtungs-Release ohne Runtime-Code-Änderung (`src/`,
`Dockerfile`, Dependencies identisch zu 0.1.0): Harness-Baseline-
Adoption, d-check-`ids`/`codepaths`-Disziplin, Doku-Sweeps und
M8-Roadmap-Planung.
