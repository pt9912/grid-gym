...
- **M4 — Protocol Adapters** · `In Progress`
  ...
  - Wave 6a — cross-adapter hardening (OTel-span-wrap +
    ...
    `strict_bytes`) · `Done`
  - Wave 6b — IEC-61850 license/smoke hardening · `Pending`
  - Wave 7 — closure · `Pending`
- **M5 — UI + Demo** · `Pending`
- **M6 — Performance + Security + CI/CD** · `Pending`

**Test balance:** 1564 unit tests + 35 integration tests passed + 4 skipped
(state after M4 Wave 6a closure — +27 unit tests vs. Wave 5b for
cross-adapter hardening: 13 OTel-span-wrap tests +
