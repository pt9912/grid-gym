...
| GG-SIM-008           | Snapshot/Resume traegt Pause/Resume de-facto (`TickLoop.from_snapshot`). Formale `RunControlPort`-API ([`GG-AR-PORT-DRV-001`](architecture.md#driving-ports-vom-kern-angeboten)) kommt mit Multi-Agent / Run-Lifecycle.                                                                                                                                                                                                                          | 🔲 M3       |
...
| GG-RT-003            | `hexagon/core/domain/quality.py` Enum-Wert `stale` vorhanden; `max_age`-basierte Markierung im Tick-Schritt 6 (Quality-Markierung) kommt mit M3 ([`GG-AR-COMP-CORE`](architecture.md#5-komponentensicht) Quality-Pipeline). M2-Geraete liefern Wert+Quality-Tupel ohne stale-Logik.                                                                                                                                                | 🔲 M3       |
...
| GG-SAFE-001..004     | Quality-Markierung-Pipeline (`GG-RT-003`-Pfad) — M3 mit der Tick-Loop-Quality-Stage 6. `RandomPort`-Seeding (`GG-SEED-001`) ist [`ADR 0007`](../docs/plan/adr/0007-random-port.md) (`Accepted` 2026-05-17).                                                                                                                                                                                                                          | ✓ M1 (Seed), 🔲 M3 (Quality-Pipeline) |
