...
| GG-ARCH-002        | [`GG-AR-P-002`](architecture.md#2-architekturprinzipien) Hexagonale Architektur                                                              |
| GG-ARCH-003        | Dependency Rule + [`GG-AR-TABU-001`](architecture.md#architektur-tabus-build-architekturtest) / [`GG-AR-TABU-002`](architecture.md#architektur-tabus-build-architekturtest)                                             |
| GG-ARCH-004        | [`GG-AR-COMP-DEVICES`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRN-007`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                       |
| GG-ARCH-005        | [`GG-AR-COMP-CORE`](architecture.md#5-komponentensicht) Tick-Loop + Domain-Event ([`GG-AR-COMP-DOMAIN`](architecture.md#5-komponentensicht))                                  |
| GG-ARCH-006        | [`GG-AR-COMP-SCHED`](architecture.md#5-komponentensicht) Tie-Breaking + [`GG-AR-P-008`](architecture.md#2-architekturprinzipien) Determinismus-Invariante                          |
| GG-ARCH-007        | [`GG-AR-PORT-DRN-001`](architecture.md#driven-ports-vom-kern-aufgerufen) (`ClockPort`) + [`GG-AR-TABU-005`](architecture.md#architektur-tabus-build-architekturtest)                                              |
| GG-ARCH-008        | [`GG-AR-P-007`](architecture.md#2-architekturprinzipien) Live- und Replay-Tick-Loop geteilt                                                  |
| GG-PRINC-001       | [`GG-AR-P-001`](architecture.md#2-architekturprinzipien)..014 Architekturprinzipien — SOLID gesamt als Architekturzusicherung; automatisierte Teilabdeckung siehe `GG-PRINC-002..006` |
...
| GG-PRINC-006       | DIP — [`GG-AR-TABU-001`](architecture.md#architektur-tabus-build-architekturtest)/002 + [`AC-CORE-NO-ADAPTERS`](../docs/plan/adr/0002-language-and-build-stack.md#a-1--architekturtests-verbindlich-automatisiert)/[`AC-CORE-NO-DRIVING`](../docs/plan/adr/0002-language-and-build-stack.md#a-1--architekturtests-verbindlich-automatisiert)/[`AC-NO-FW`](../docs/plan/adr/0002-language-and-build-stack.md#a-1--architekturtests-verbindlich-automatisiert)/[`AC-PORTS-NO-FW`](../docs/plan/adr/0002-language-and-build-stack.md#a-1--architekturtests-verbindlich-automatisiert) (vier von fuenfzehn A-1-Contracts in [`ADR 0002`](../docs/plan/adr/0002-language-and-build-stack.md)) |
| GG-CC-002          | [`GG-AR-TABU-003`](architecture.md#architektur-tabus-build-architekturtest) (Adapter-Logikverbot)                                                            |
| GG-CC-003          | [`GG-AR-TABU-002`](architecture.md#architektur-tabus-build-architekturtest) (Domain ohne Framework-Imports)                                                  |
| GG-CC-004          | [`GG-AR-TABU-004`](architecture.md#architektur-tabus-build-architekturtest) (keine Zyklen)                                                                    |
| GG-CC-006          | [`GG-AR-TABU-007`](architecture.md#architektur-tabus-build-architekturtest) (keine God-Utility-Classes)                                                       |
| GG-CC-007          | [`GG-AR-TABU-006`](architecture.md#architektur-tabus-build-architekturtest) (immutable Domain-Objekte) + [`GG-AR-COMP-DOMAIN`](architecture.md#5-komponentensicht)                                  |
| GG-CC-008          | [`GG-AR-TABU-008`](architecture.md#architektur-tabus-build-architekturtest) (explizite Fehlerbehandlung)                                                      |
...
| GG-SIM-001..004    | [`GG-AR-COMP-CORE`](architecture.md#5-komponentensicht) Tick-Loop + [`GG-AR-P-008`](architecture.md#2-architekturprinzipien) Determinismus-Invariante                              |
| GG-SIM-005         | [`GG-AR-PORT-DRV-005`](architecture.md#driving-ports-vom-kern-angeboten) (`SnapshotPort`)                                                              |
| GG-SIM-006         | [`GG-AR-PORT-DRV-003`](architecture.md#driving-ports-vom-kern-angeboten) (`ReplayPort`) + [`GG-AR-P-007`](architecture.md#2-architekturprinzipien) geteilter Tick-Loop                            |
| GG-SIM-007         | [`GG-AR-COMP-CORE`](architecture.md#5-komponentensicht) Wall-Clock-Multiplikatoren (Replay-Faktoren)                                    |
| GG-SIM-008         | [`GG-AR-PORT-DRV-001`](architecture.md#driving-ports-vom-kern-angeboten) (`RunControlPort`)                                                            |
| GG-SIM-009         | [`GG-AR-COMP-DOMAIN`](architecture.md#5-komponentensicht) `RunMetadata` + [`GG-AR-COMP-PERSIST`](architecture.md#5-komponentensicht) Schema                                    |
| GG-RT-001          | [`GG-AR-COMP-CORE`](architecture.md#5-komponentensicht) Tick-Dauer 10ms–1s, MVP-Modus-Definition                                        |
| GG-RT-002          | [`GG-AR-COMP-CORE`](architecture.md#5-komponentensicht) + [`GG-AR-P-008`](architecture.md#2-architekturprinzipien) Determinismus-Invarianten                                       |
| GG-RT-003          | [`GG-AR-COMP-DOMAIN`](architecture.md#5-komponentensicht) Quality-Markierung (`stale`) + [`GG-AR-PORT-DRN-001`](architecture.md#driven-ports-vom-kern-aufgerufen)                            |
| GG-RT-004/005      | [`GG-AR-COMP-OBS`](architecture.md#5-komponentensicht) Metriken + [`GG-AR-COMP-CORE`](architecture.md#5-komponentensicht) Commit-Pipeline                                      |
| GG-RT-006          | [`GG-AR-COMP-REPLAY`](architecture.md#5-komponentensicht) Replay-Faktor-Tabelle                                                          |
| GG-DATA-001..004   | [`GG-AR-COMP-DOMAIN`](architecture.md#5-komponentensicht) (TelemetryPoint, Command, Quality)                                            |
| GG-DATA-005        | [`GG-AR-COMP-DOMAIN`](architecture.md#5-komponentensicht) + [`GG-AR-COMP-SCENARIO`](architecture.md#5-komponentensicht) kanonische Serialisierung                              |
| GG-DEV-001         | [`GG-AR-COMP-DEVICES`](architecture.md#5-komponentensicht) Geraetemodell-Vertrag                                                         |
| GG-DEV-002         | [`GG-AR-COMP-DOMAIN`](architecture.md#5-komponentensicht) `TelemetryPoint`                                                               |
| GG-DEV-003         | [`GG-AR-COMP-DOMAIN`](architecture.md#5-komponentensicht) `Command` + REST/WS-API in [`GG-AR-COMP-API`](architecture.md#5-komponentensicht)                                    |
| GG-DEV-010..018    | [`GG-AR-COMP-DEVICES`](architecture.md#5-komponentensicht) (MVP- und SOLLTE-Modelle)                                                     |
| GG-BESS-001..008   | [`GG-AR-COMP-DEVICES`](architecture.md#5-komponentensicht) (Batteriemodell) + [`GG-AR-P-010`](architecture.md#2-architekturprinzipien) Eingabe-Sicherheit                           |
| GG-GRID-001..007   | [`GG-AR-COMP-DEVICES`](architecture.md#5-komponentensicht) (Netzmodell)                                                                  |
| GG-SCN-001..008    | [`GG-AR-COMP-SCENARIO`](architecture.md#5-komponentensicht) Validierungs-Pipeline                                                        |
| GG-REPLAY-001..006 | [`GG-AR-COMP-REPLAY`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRV-003`](architecture.md#driving-ports-vom-kern-angeboten)                                                         |
| GG-REPLAY-007      | [`GG-AR-COMP-REPLAY`](architecture.md#5-komponentensicht) Diff-Klassifikation                                                            |
| GG-FAULT-001..010  | [`GG-AR-COMP-FAULTS`](architecture.md#5-komponentensicht) Fault-Injection-Architektur                                                    |
| GG-AGENT-001..008  | [`GG-AR-COMP-AGENTS`](architecture.md#5-komponentensicht) Multi-Agent-Subsystem                                                          |
| GG-API-001         | [`GG-AR-COMP-API`](architecture.md#5-komponentensicht) REST-Endpunkte (`/runs`, `/runs/{id}/...`)                                        |
| GG-API-002         | [`GG-AR-COMP-API`](architecture.md#5-komponentensicht) WebSocket-Telemetrie                                                              |
| GG-API-003         | [`GG-AR-COMP-API`](architecture.md#5-komponentensicht) OpenAPI                                                                            |
| GG-API-004         | [`GG-AR-COMP-API`](architecture.md#5-komponentensicht) Fehlerformat                                                                       |
| GG-MQTT-001        | [`GG-AR-COMP-PROTOCOLS`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRN-007`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                       |
| GG-MODB-001        | [`GG-AR-COMP-PROTOCOLS`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRN-007`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                       |
| GG-OPCUA-001       | [`GG-AR-COMP-PROTOCOLS`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRN-007`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                       |
| GG-DNP3-001        | [`GG-AR-COMP-PROTOCOLS`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRN-007`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                       |
| GG-IEC-001         | [`GG-AR-COMP-PROTOCOLS`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRN-007`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                       |
| GG-SNMP-001        | [`GG-AR-COMP-PROTOCOLS`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRN-007`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                       |
| GG-LWM2M-001       | [`GG-AR-COMP-PROTOCOLS`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRN-007`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                       |
| GG-UI-001..009     | [`GG-AR-COMP-UI`](architecture.md#5-komponentensicht)                                                                                     |
| GG-PERSIST-001..004 | [`GG-AR-COMP-PERSIST`](architecture.md#5-komponentensicht) Schema + [`GG-AR-PORT-DRN-002`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                 |
| GG-PERSIST-005     | [`GG-AR-COMP-PERSIST`](architecture.md#5-komponentensicht) (PostgreSQL Pflicht)                                                          |
| GG-PERSIST-006/007 | [`GG-AR-COMP-PERSIST`](architecture.md#5-komponentensicht) optionale Adapter (Timescale / Influx)                                         |
| GG-PERSIST-008     | [`GG-AR-COMP-PERSIST`](architecture.md#5-komponentensicht) Migrations-Schicht                                                             |
| GG-PERSIST-009     | [`GG-AR-PORT-DRN-003`](architecture.md#driven-ports-vom-kern-aufgerufen) + [`GG-AR-COMP-PERSIST`](architecture.md#5-komponentensicht) `RunRepositoryPort`                                     |
| GG-OTEL-001..004   | [`GG-AR-COMP-OBS`](architecture.md#5-komponentensicht) + [`GG-AR-PORT-DRN-008`](architecture.md#driven-ports-vom-kern-aufgerufen)                                                             |
| GG-SAFE-001..004   | [`GG-AR-P-010`](architecture.md#2-architekturprinzipien) Sicherer Default + [`GG-AR-COMP-CORE`](architecture.md#5-komponentensicht) Quality-Markierung                               |
| GG-SAFE-005        | [`GG-AR-P-010`](architecture.md#2-architekturprinzipien) Sicherer Default (Fallback-Variante in [`GG-AR-COMP-DEVICES`](architecture.md#5-komponentensicht))                          |
| GG-SAFE-006        | [`GG-AR-COMP-REPLAY`](architecture.md#5-komponentensicht) Diff + [`GG-AR-COMP-OBS`](architecture.md#5-komponentensicht) Replay-Diff-Status                                      |
| GG-SAFE-007        | [`GG-AR-P-011`](architecture.md#2-architekturprinzipien) Trennung Simulation/Produktion                                                        |
| GG-SAFE-008        | [`GG-AR-COMP-API`](architecture.md#5-komponentensicht) Eingabe-Validierung + [`GG-AR-COMP-SCENARIO`](architecture.md#5-komponentensicht) Scenario-Validator                     |
| GG-TESTTYPE-001..007 | [`GG-AR-TEST-001`](architecture.md#18-rueckverfolgbarkeit-architektur--lastenheft)                                                                                  |
| GG-ARCHTEST-001..005 | [`GG-AR-TABU-001`](architecture.md#architektur-tabus-build-architekturtest)..008 + [`GG-AR-TEST-001`](architecture.md#18-rueckverfolgbarkeit-architektur--lastenheft)                                                          |
| GG-CICD-001..007   | [`GG-AR-TEST-001`](architecture.md#18-rueckverfolgbarkeit-architektur--lastenheft) + [`GG-AR-COMP-DEPLOY`](architecture.md#5-komponentensicht)                                                              |
| GG-DEPLOY-001..011 | [`GG-AR-COMP-DEPLOY`](architecture.md#5-komponentensicht)                                                                                 |
| GG-DEMO-001..008   | [`GG-AR-COMP-DEPLOY`](architecture.md#5-komponentensicht) (Compose-Demo) + [`GG-AR-TEST-001`](architecture.md#18-rueckverfolgbarkeit-architektur--lastenheft) (E2E/Demo-Abnahme)                            |
| GG-ACCEPT-001..003 | [`GG-AR-TEST-001`](architecture.md#18-rueckverfolgbarkeit-architektur--lastenheft) + `GG-TRACE-001`                                                                   |
| GG-TRACE-001       | Rueckverfolgbarkeitstabelle in `architecture.md` (§18) — Quelle fuer diese §27.1-Tabelle             |
| GG-TEST-001..008   | [`GG-AR-TEST-001`](architecture.md#18-rueckverfolgbarkeit-architektur--lastenheft) (Replay-/Fault-/Determinismus-Tests)                                               |
| GG-COV-001..005    | [`GG-AR-TEST-001`](architecture.md#18-rueckverfolgbarkeit-architektur--lastenheft) (Coverage-Block und Quality Gates)                                                 |
| GG-QG-001..007     | [`GG-AR-TEST-001`](architecture.md#18-rueckverfolgbarkeit-architektur--lastenheft) (Quality Gates) + [`GG-AR-COMP-DEPLOY`](architecture.md#5-komponentensicht) (CI-Gating)                                   |
| GG-QA-001..006     | [`GG-AR-TEST-001`](architecture.md#18-rueckverfolgbarkeit-architektur--lastenheft) + [`GG-AR-TABU-001`](architecture.md#architektur-tabus-build-architekturtest)..008 (statische Pruefungen)                                     |
...
| GG-SIM-005           | `hexagon/core/simulation/tick_loop.py::snapshot/from_snapshot`, `hexagon/core/domain/snapshot.py` (`SnapshotEnvelope`), Composition via `hexagon/ports/driven/random.py::snapshot_as_mapping` ([`ADR 0010`](../docs/plan/adr/0010-randomport-snapshot-as-mapping.md)).                                                                                                                                                                                    | ✓ M1        |
...
| GG-SIM-008           | Snapshot/Resume traegt Pause/Resume de-facto (`TickLoop.from_snapshot`). Formale `RunControlPort`-API ([`GG-AR-PORT-DRV-001`](architecture.md#driving-ports-vom-kern-angeboten)) kommt mit Multi-Agent / Run-Lifecycle.                                                                                                                                                                                                                          | ✓ M5 |
...
| GG-RT-003            | `hexagon/core/domain/quality.py` Enum-Wert `stale` vorhanden; `max_age`-basierte Markierung im Tick-Schritt 6 (Quality-Markierung) kommt mit M3 ([`GG-AR-COMP-CORE`](architecture.md#5-komponentensicht) Quality-Pipeline). M2-Geraete liefern Wert+Quality-Tupel ohne stale-Logik.                                                                                                                                                | ✓ M6/M7 |
...
| GG-DATA-005          | `hexagon/core/serialization/canonical.py::canonical_json` ([`ADR 0002`](../docs/plan/adr/0002-language-and-build-stack.md) §A-2); [`AC-NO-JSON`](../docs/plan/adr/0002-language-and-build-stack.md#a-1--architekturtests-verbindlich-automatisiert) Whitelist auf dieses Modul. Payload-Canonical-Check `hexagon/core/serialization/snapshot_codec.py` (M2, Trigger 014).                                                                                                                                                                       | ✓ M1        |
| GG-DEV-001           | `DeviceModel`-Protocol (`initialize`/`apply_command`/`tick`/`snapshot`/`telemetry` + `device_id`-Property + `from_snapshot`-Classmethod) in `hexagon/core/devices/_protocol.py` (M2). [`ADR 0013`](../docs/plan/adr/0013-device-model-protocol.md) `Accepted` mit Review-Schaerfungen (§§2.5-2.8 + §8). Geraete-Implementationen (`GG-DEV-010..014`) sind weiterhin M2. | ✓ M2 |
...
| GG-DEV-010           | `BatteryDevice` in `hexagon/core/devices/battery/` (M2, [`ADR 0014`](../docs/plan/adr/0014-battery-snapshot-schema.md) `Accepted`). Minimalmodell, Snapshot-Roundtrip, Determinismus-Property ueber 100 Ticks, Trigger-013-Test mit `tick_ms=100`. Demo-Szenario folgt mit M2.                                                                                                                                                       | ✓ M2 |
| GG-DEV-011           | `PvDevice` in `hexagon/core/devices/pv/` (M2, [`ADR 0016`](../docs/plan/adr/0016-pv-load-device-pattern.md) `Accepted`). Konstantes `rated_power_kw`-Erzeugungsmodell mit `set_power_kw`-Override; Sign-Vertrag-Pruefung + Snapshot-Roundtrip + Determinismus-Property ueber 100 Ticks.                                                                                                                                                    | ✓ M2 |
| GG-DEV-013           | `LoadDevice` in `hexagon/core/devices/load/` (M2, [`ADR 0016`](../docs/plan/adr/0016-pv-load-device-pattern.md) `Accepted`). Spiegel zu PV; Sign-Konvention „Load verbraucht nicht-negativ".                                                                                                                                                                                                                                              | ✓ M2 |
...
| GG-BESS-001..005, 008 | `BatteryDevice` + `BatteryConfig` + `validate_set_power_command` (M2, [`ADR 0014`](../docs/plan/adr/0014-battery-snapshot-schema.md) `Accepted`). SOC-Fortschreibung mit Wirkungsgrad, Ramp-Limit, SOC-Hard-Clamp, Initialvalidierung pro Feld.                                                                                                                                                                                              | ✓ M2 |
...
| GG-REPLAY-007        | `hexagon/core/replay/diff.py` (`diff_replay`, Trigger 013 `tick_ms`-Parameter in M2 (Commit `48f0106`) geliefert; Closure-Notiz [`done/013-replay-diff-tick-ms-parameter.md`](../docs/plan/planning/done-archive/013-replay-diff-tick-ms-parameter.md)).                                                                                                                                       | ✓ M1+M2     |
...
| GG-MQTT-001          | MQTT-Adapter (`adapters/driven/protocol_mqtt/`) — M4 ([`ADR 0031`](../docs/plan/adr/0031-mqtt-adapter-profile.md) `Provisional`; siehe [`spec/protocol_profiles.md`](protocol_profiles.md) §MQTT). Topic-Schema inline, `canonical_json`-Codec, QoS 0/1, Per-Target `queue.Queue`-Marshal, Mosquitto-Integration-Smoke.                                                                                                                       | ✅ M4       |
| GG-MODB-001          | Modbus-Adapter (`adapters/driven/protocol_modbus/`) — M4 + Slice 031 ([`ADR 0032`](../docs/plan/adr/0032-modbus-adapter-profile.md) `Provisional`; siehe [`spec/protocol_profiles.md`](protocol_profiles.md) §Modbus-TCP). Register-Schema inline, 5 Datatypes, direkt-sync, FC03/FC10-Defaults mit FC04/FC06-Overrides, in-process pymodbus-Smoke.                                                                                            | ✅ M4       |
...
| GG-DNP3-001          | DNP3-Adapter (`adapters/driven/protocol_dnp3/`) — M4 ([`ADR 0034`](../docs/plan/adr/0034-dnp3-adapter-profile.md) `Provisional`; siehe [`spec/protocol_profiles.md`](protocol_profiles.md) §DNP3). **Zwei-Library-Setup** `nfm-dnp3` (Master, MIT, produktiv) + `dnp3-outstation` (Outstation, MIT, **nur Test-Sibling**). Group/Variation-Set `{(1,1),(1,2),(30,1),(30,5)}`, Class-0-Polling-Read mit Resultat-Filter-by-Index. **Erfuellung ueber Pfad A** (Adapter geliefert); historische Akzeptanz erlaubte alternativ dokumentierten Out-of-Scope-Verzicht (Slice 034 F15: Audit-Trail-Note).            | ✅ M4       |
| GG-IEC-001           | IEC-61850-Adapter (`adapters/driven/protocol_iec61850/`) — M4 + Slice 033 ([`ADR 0035`](../docs/plan/adr/0035-iec61850-adapter-profile.md) `Provisional`; siehe [`spec/protocol_profiles.md`](protocol_profiles.md) §IEC-61850). **GPLv3-isoliert** per SPDX-Header pro Datei (Decision I-f; **erstmaliger Repo-Praezedenzfall** fuer GPL-isolierte Sub-Module in einem sonst MIT-Projekt). `pyiec61850-ng` als opt-in Extra `pip install grid-gym[iec61850]`. Datatype-Set `{bool,int32,float,string}` × FC `{MX,ST,SP,CF,DC}`. Integration-Smoke aktuell unter 2c-Mock-only-Fallback (Python-3.14-SWIG-Inkompat; Folge-Schaerfung). **Erfuellung ueber Pfad A** (Adapter geliefert); historische Akzeptanz erlaubte alternativ dokumentierten Out-of-Scope-Verzicht (Slice 034 F15: Audit-Trail-Note). | ✅ M4       |
...
| GG-SAFE-001..004     | Quality-Markierung-Pipeline (`GG-RT-003`-Pfad) — M3 mit der Tick-Loop-Quality-Stage 6. `RandomPort`-Seeding (`GG-SEED-001`) ist [`ADR 0007`](../docs/plan/adr/0007-random-port.md) (`Accepted` 2026-05-17).                                                                                                                                                                                                                          | ✓ M6/M7 |
...
| GG-SAFE-007          | Trennung Simulation/Produktion — `GG-NONGOAL-001` + `README.md`-Disclaimer. Architektur-Pruefung in `tools/arch_check.py` ([`AC-HEXAGON-PURE`](../docs/plan/adr/0002-language-and-build-stack.md#a-1--architekturtests-verbindlich-automatisiert)-Whitelist).                                                                                                                                                                                                                                       | ✓ M1        |
...
| GG-QA-001..006       | `make lint` (ruff BLE/TRY/B/DTZ/S/TID/PLR*/N), `make typecheck` (mypy --strict, [`ADR 0005`](../docs/plan/adr/0005-type-check-gate.md)), `make dep-audit` (pip-audit `--strict`), `make image-audit` (trivy). SBOM ist `GG-CICD-007` (M6).                                                                                                                                                                                                | ✓ M1        |
