...
| GG-DEV-001..003      | `DeviceModel`-Protocol (`initialize`/`tick`/`apply_command`/`snapshot`/`telemetry`) kommt mit M2-Welle-1 (Slice-Plan [`M2-devices.md`](../docs/plan/planning/in-progress/M2-devices.md)). ADR 0013 vorgesehen.                                                                                                                                                                                | 🔲 M2       |
| GG-DEV-010..014      | MVP-Geraete `battery/pv/load/grid_connection/smart_meter` — M2-Welle-2..4 (Slice-Plan).                                                                                                                                                                                                                                                                                                       | 🔲 M2       |
...
| GG-BESS-001..005/008 | Batteriemodell mit SOC, Lade-/Entlade-Grenzen, Wirkungsgraden, Ramp-Limits, Sicherheitsvalidierung, Initialvalidierung — M2-Welle-2 (Slice-Plan §3 Welle 2 + ADR 0014).                                                                                                                                                                                                                       | 🔲 M2       |
...
| GG-REPLAY-007        | `hexagon/core/replay/diff.py` (`diff_replay`, Trigger 013 `tick_ms`-Parameter wird in M2 Welle 2 mit dem Battery-Pflicht-Test geschlossen).                                                                                                                                                                                                                                                    | ✓ M1        |
