"""Drift-Detection fuer `_DEVICE_DECIMAL_PARAMS`-Allowlist
...
und der Eintrag im Test-seitigen YAML-Loader-Allowlist
(`_yaml_scenario_loader._DEVICE_DECIMAL_PARAMS`) vergessen wird,
...
Decimal-Feld in `_DEVICE_DECIMAL_PARAMS` enthalten ist. Faellt
...
from tests.integration._yaml_scenario_loader import _DEVICE_DECIMAL_PARAMS
...
def test_yaml_loader_allowlist_covers_all_device_decimal_fields() -> None:
    """Welle-6c-Review M-3: `_DEVICE_DECIMAL_PARAMS` muss alle
    ...
    missing = expected - _DEVICE_DECIMAL_PARAMS
    assert not missing, (
        "tests/integration/_yaml_scenario_loader.py::_DEVICE_DECIMAL_PARAMS "
...
def test_yaml_loader_allowlist_has_no_orphan_entries() -> None:
    """Welle-6c-Review M-3: jeder Eintrag in `_DEVICE_DECIMAL_PARAMS`
    ...
    orphans = _DEVICE_DECIMAL_PARAMS - actual
    assert not orphans, (
        "tests/integration/_yaml_scenario_loader.py::_DEVICE_DECIMAL_PARAMS "
