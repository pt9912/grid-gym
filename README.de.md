...
- **M5 — UI + Demo** · `Pending` (naechster aktiver Slice)
- **M6 — Performance + Security + CI/CD** · `Pending`

**Testbilanz:** 1584 Unit-Tests + 35 Integration-Tests passed + 4 skipped
(Stand nach M4-Welle-6b-Closure inkl. M4-Welle-7-Closure
2026-06-01 — +20 Unit-Tests ggue. Welle 6a fuer Welle 6b:
